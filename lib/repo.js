...
(function() {
  var Actor, Commit, Config, Diff, Head, PushUpstream, Ref, RemoteBranches, RemoteSimple, Repo, Status, StatusAdv, Tag, Tree, _, cmd, ref;
  ...
  module.exports = Repo = (function() {
    ...
    Repo.prototype.remoteNames = function(options, callback) {
      var ref1;
      if (!callback) {
    ...
    Repo.prototype.remoteBranches = function(options, callback) {
    ...
    Repo.prototype.statusAdv = function(options, callback) {
      var ref1;
      if (!callback) {
        ref1 = [callback, options], options = ref1[0], callback = ref1[1];
      }
    ...
    Repo.prototype.delete_branch = function(name, force, callback) {
      var opts, ref1;
      if (!callback) {
        ref1 = [false, force], force = ref1[0], callback = ref1[1];
      }
      opts = {
        d: true
      };
      ...
      return this.git("branch", opts, name, function(err, stdout, stderr) {
        return callback(err);
      });
    };
    ...
    Repo.prototype.pushUpstream = function(options, callback) {
